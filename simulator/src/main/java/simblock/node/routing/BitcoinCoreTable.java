...
public class BitcoinCoreTable extends AbstractRoutingTable {
  ...
  //TODO add example
  /**
   * Keep track of the connection between getSelfNode() and endNode.
   * The body of the function must be uncommented if SimBlock Visualizer needs to be used.
   */
  ...
  //TODO add example
  /**
   * Keep track of the connection removed between getSelfNode() and endNode.
   * The body of the function must be uncommented if SimBlock Visualizer needs to be used.
   */
