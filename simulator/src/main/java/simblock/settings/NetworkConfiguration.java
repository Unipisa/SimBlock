...
public class NetworkConfiguration {
  ...
  /**
   * LATENCY[i][j] is average latency from REGION_LIST[i] to REGION_LIST[j]
   * Unit: millisecond, for year 2021 (from 1 March, 2021 to April 13, 2021)
   * Source: 
   *   https://www.verizon.com/business/solutions/business-continuity/weekly-latency-statistics/
   *   https://www.verizon.com/business/terms/latency/
   *   https://wondernetwork.com/pings
   */
  private static final long[][] LATENCY_2021 = {
      {30, 86, 187, 230, 158, 152},
      {86, 12, 240, 236, 227, 253},
   ...
   */
  public static final long[][] LATENCY = LATENCY_2021;//LATENCY_2019;
  ...
  /**
   * List of download bandwidth assigned to each region, and last element is Inter-regional
   * bandwidth. (unit: bit per second) for year 2021 (from 1 March, 2021 to April 13, 2021)
   * Source: 
   *   https://testmy.net/list/countrycode.3/1/40000
   *   https://testmy.net/list/countrycode.3/2/40000
   */
  private static final long[] DOWNLOAD_BANDWIDTH_2021 = {
      41000000, 39000000, 21000000, 20000000,
      29000000, 46000000, 6 * 1000000
  };
   ...
   */
  public static final long[] DOWNLOAD_BANDWIDTH = DOWNLOAD_BANDWIDTH_2021;//DOWNLOAD_BANDWIDTH_2019;
  ...
  /**
   * List of upload bandwidth assigned to each region. (unit: bit per second), and last element
   * is Inter-regional bandwidth for year 2021 (from 1 March, 2021 to April 13, 2021)
   * Source: 
   *   https://testmy.net/list/countrycode.3/1/40000
   *   https://testmy.net/list/countrycode.3/2/40000
   */
  private static final long[] UPLOAD_BANDWIDTH_2021 = {
      13000000, 17000000, 6000000, 13000000,
      18000000, 17000000, 6 * 1000000
  };
   ...
   */
  public static final long[] UPLOAD_BANDWIDTH = UPLOAD_BANDWIDTH_2021;//UPLOAD_BANDWIDTH_2019;
  ...
  /**
   * Region distribution Bitcoin 2021 (from 1 March, 2021 to April 13, 2021)
   * Source: Statistics on data retrieved by Bitnodes.io API 
   */
  private static final double[] REGION_DISTRIBUTION_BITCOIN_2021 = {
      0.188616, 0.597868, 0.0433491,
      0.136794, 0.0158874, 0.0174855
  };
   ...
   */
  public static final double[] REGION_DISTRIBUTION = REGION_DISTRIBUTION_BITCOIN_2021;
