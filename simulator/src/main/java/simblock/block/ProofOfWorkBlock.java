...
public class ProofOfWorkBlock extends Block {
   ...
   * @param time       the time (datatype converted from long to BigInteger)
   * @param difficulty the difficulty (datatype converted from long to BigInteger)
   */
  public ProofOfWorkBlock(ProofOfWorkBlock parent, Node minter, BigInteger time, BigInteger difficulty) {
  ...
  public static ProofOfWorkBlock genesisBlock(Node minter) {
    ...
    return new ProofOfWorkBlock(null, minter, new BigInteger ("0"), BigInteger.ZERO);
  }
}
