...
public class Block {
   ...
   * Datatype converted from long to BigInteger
   */
   ...
   */
  public Block(Block parent, Node minter, BigInteger time) {
   ...
   * Get time.
   *
   * @return the time (datatype converted from long to BigInteger)
   */
  //TODO what format
  ...
  public static Block genesisBlock(Node minter) {
    return new Block(null, minter, new BigInteger("0"));
  }
